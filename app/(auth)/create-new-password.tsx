        ...
        <View style={modalStyles.overlay}>
            <View style={modalStyles.card}>
                ...
                <Text style={modalStyles.body}>
                    Your account is ready to use. You will be redirected to the Sign In page in a few seconds.
                </Text>
...
const modalStyles = StyleSheet.create({
    ...
    card: { backgroundColor: COLORS.white, borderRadius: 40, padding: SPACING.xl, alignItems: 'center', width: '100%' },
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
                ...
                <TextField icon="lock-closed" placeholder="New Password" value={password} onChangeText={setPassword} secureTextEntry style={styles.input} />
                <TextField icon="lock-closed" placeholder="Confirm New Password" value={confirmPassword} onChangeText={setConfirmPassword} secureTextEntry style={styles.input} />
...
const styles = StyleSheet.create({
    ...
    illustrationContainer: { alignItems: 'center', justifyContent: 'center', marginVertical: SPACING.xl },
    illustrationBg: { width: 240, height: 240, backgroundColor: COLORS.primaryLight, borderRadius: 120, alignItems: 'center', justifyContent: 'center', position: 'relative' },
    lockIcon: { opacity: 0.8 },
    shieldBadge: { position: 'absolute', bottom: 20, right: 10, backgroundColor: COLORS.primary, width: 70, height: 70, borderRadius: 35, alignItems: 'center', justifyContent: 'center', borderWidth: 4, borderColor: COLORS.white, ...SHADOWS.large },
