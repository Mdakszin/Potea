...
export default function ShippingAddressScreen() {
    ...
    const fetchAddresses = async () => {
        ...
        try {
            ...
            const addressList = querySnapshot.docs.map(doc => ({ id: doc.id, ...doc.data() } as Address));
            addressList.sort((a, b) => (b.isDefault ? 1 : 0) - (a.isDefault ? 1 : 0));
            ...
            {loading ? (
                ...
                <>
                    <FlatList 
                        ...
                        ListEmptyComponent={<Text style={{ textAlign: 'center', marginTop: 50, color: colors.textLight }}>No addresses found.</Text>} 
                    />
                    <View style={styles.footer}>
                        <Button title="Add New Address" onPress={() => router.push('/(main)/add-address')} style={{ width: '100%' }} />
                    </View>
                </>
            )}
        </SafeAreaView>
