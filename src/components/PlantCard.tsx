...
import { View, Text, StyleSheet, Image, TouchableOpacity, ViewStyle, StyleProp, Alert } from 'react-native';
...
export default function PlantCard({ item, onPress, onToggleFavorite, style }: PlantCardProps) {
