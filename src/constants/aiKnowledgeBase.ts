...
export interface AIKnowledgeBase {
    greetings: string[];
    typing_indicators: string[];
    categories: {
        care: AICategory & { responses: Record<string, string>; general: string };
        shipping: AICategory & { responses: string[] };
        returns: AICategory & { responses: string[] };
        fallback: string[];
    };
