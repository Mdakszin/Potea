...
export default function InviteFriendsScreen({ navigation }) {
    ...
    const renderItem = ({ item }) => (
        <View style={styles.contactItem}>
            ...
            <TouchableOpacity
                style={[styles.inviteBtn, item.invited && styles.invitedBtn]}
...
const styles = StyleSheet.create({
    ...
    contactInfo: { flex: 1 },
    nameLabel: { ...TYPOGRAPHY.body, fontWeight: '700', color: COLORS.text },
    phoneLabel: { ...TYPOGRAPHY.bodySmall, color: COLORS.textLight, marginTop: 2 },
    inviteBtn: {
    ...
    inviteText: { ...TYPOGRAPHY.bodySmall, color: COLORS.white, fontWeight: '700' },
    invitedText: { color: COLORS.primary },
});
